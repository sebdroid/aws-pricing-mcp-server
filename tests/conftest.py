...
@pytest.fixture
def sample_bulk_api_response() -> Dict[str, Any]:
    """Sample Bulk API response with products and terms keyed by SKU."""
    return {
        'products': {
            'SKU001': {
                'sku': 'SKU001',
...
@pytest.fixture
def sample_service_index() -> Dict[str, Any]:
    """Sample service index response from the Bulk API."""
    return {
        'offers': {
